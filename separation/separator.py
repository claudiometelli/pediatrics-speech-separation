...
from config import ROOT_DIR, MAIN_INPUT_DIR, AUDIO_DIR, PATIENTS_DIR, MAIN_OUTPUT_DIR, SEPFORMER_OUTPUT_DIR
...
output_dir = ROOT_DIR + MAIN_OUTPUT_DIR + AUDIO_DIR + PATIENTS_DIR + patient_directory + SEPFORMER_OUTPUT_DIR
